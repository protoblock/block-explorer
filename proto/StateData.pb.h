...
class InsideBookMeta : public ::google::protobuf::Message {
 public:
  InsideBookMeta();
  virtual ~InsideBookMeta();

  InsideBookMeta(const InsideBookMeta& from);

  inline InsideBookMeta& operator=(const InsideBookMeta& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const InsideBookMeta& default_instance();

  void Swap(InsideBookMeta* other);

  // implements Message ----------------------------------------------

  InsideBookMeta* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const InsideBookMeta& from);
  void MergeFrom(const InsideBookMeta& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline bool has_totsize() const;
  inline void clear_totsize();
  static const int kTotsizeFieldNumber = 10;
  inline ::google::protobuf::int32 totsize() const;
  inline void set_totsize(::google::protobuf::int32 value);

  // optional bytes orderidroot = 20;
  inline bool has_orderidroot() const;
  inline void clear_orderidroot();
  static const int kOrderidrootFieldNumber = 20;
  inline const ::std::string& orderidroot() const;
  inline void set_orderidroot(const ::std::string& value);
  inline void set_orderidroot(const char* value);
  inline void set_orderidroot(const void* value, size_t size);
  inline ::std::string* mutable_orderidroot();
  inline ::std::string* release_orderidroot();
  inline void set_allocated_orderidroot(::std::string* orderidroot);

  // @@protoc_insertion_point(class_scope:fantasybit.InsideBookMeta)
 private:
  inline void set_has_totsize();
  inline void clear_has_totsize();
  inline void set_has_orderidroot();
  inline void clear_has_orderidroot();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::std::string* orderidroot_;
  ::google::protobuf::int32 totsize_;
  ...
  void InitAsDefaultInstance();
  static InsideBookMeta* default_instance_;
};
// -------------------------------------------------------------------
...
// optional int32 totsize = 10;
inline bool InsideBookMeta::has_totsize() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void InsideBookMeta::set_has_totsize() {
  _has_bits_[0] |= 0x00000001u;
}
inline void InsideBookMeta::clear_has_totsize() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void InsideBookMeta::clear_totsize() {
  totsize_ = 0;
  clear_has_totsize();
}
inline ::google::protobuf::int32 InsideBookMeta::totsize() const {
  return totsize_;
}
inline void InsideBookMeta::set_totsize(::google::protobuf::int32 value) {
  set_has_totsize();
  totsize_ = value;
}

// optional bytes orderidroot = 20;
inline bool InsideBookMeta::has_orderidroot() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void InsideBookMeta::set_has_orderidroot() {
  _has_bits_[0] |= 0x00000002u;
}
inline void InsideBookMeta::clear_has_orderidroot() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void InsideBookMeta::clear_orderidroot() {
  if (orderidroot_ != &::google::protobuf::internal::kEmptyString) {
    orderidroot_->clear();
  }
  clear_has_orderidroot();
}
inline const ::std::string& InsideBookMeta::orderidroot() const {
  return *orderidroot_;
}
inline void InsideBookMeta::set_orderidroot(const ::std::string& value) {
  set_has_orderidroot();
  if (orderidroot_ == &::google::protobuf::internal::kEmptyString) {
    orderidroot_ = new ::std::string;
  }
  orderidroot_->assign(value);
}
inline void InsideBookMeta::set_orderidroot(const char* value) {
  set_has_orderidroot();
  if (orderidroot_ == &::google::protobuf::internal::kEmptyString) {
    orderidroot_ = new ::std::string;
  }
...
inline void InsideBookMeta::set_orderidroot(const void* value, size_t size) {
  set_has_orderidroot();
  if (orderidroot_ == &::google::protobuf::internal::kEmptyString) {
    orderidroot_ = new ::std::string;
  }
  orderidroot_->assign(reinterpret_cast<const char*>(value), size);
}
inline ::std::string* InsideBookMeta::mutable_orderidroot() {
  set_has_orderidroot();
  if (orderidroot_ == &::google::protobuf::internal::kEmptyString) {
    orderidroot_ = new ::std::string;
  }
...
inline ::std::string* InsideBookMeta::release_orderidroot() {
  clear_has_orderidroot();
  if (orderidroot_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
    ::std::string* temp = orderidroot_;
    orderidroot_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
inline void InsideBookMeta::set_allocated_orderidroot(::std::string* orderidroot) {
  if (orderidroot_ != &::google::protobuf::internal::kEmptyString) {
    delete orderidroot_;
  }
  if (orderidroot) {
    set_has_orderidroot();
    orderidroot_ = orderidroot;
  } else {
    clear_has_orderidroot();
    orderidroot_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
